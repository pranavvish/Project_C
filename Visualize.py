...
#changes
# Loading sample data
imu = pd.read_csv('TrainingData/subject_001_01__x.csv');
imu_t = pd.read_csv('TrainingData/subject_001_01__x_time.csv');
ann = pd.read_csv('TrainingData/subject_001_01__y.csv');
ann_t = pd.read_csv('TrainingData/subject_001_01__y_time.csv');
